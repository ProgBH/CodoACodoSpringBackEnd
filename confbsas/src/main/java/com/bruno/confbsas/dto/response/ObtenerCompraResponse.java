 ...
 */
package com.bruno.confbsas.dto.response;

// Importar las clases o paquetes necesarios según las propiedades de Compra

public class ObtenerCompraResponse {

    // Propiedades de la Compra que se enviarán en el cuerpo de la respuesta GET
    ...
    public ObtenerCompraResponse() {
    }

    public ObtenerCompraResponse(int id, String nombre, int cantidad) {
        this.id = id;
        this.nombre = nombre;
